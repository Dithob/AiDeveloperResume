...
rem   script\package_overleaf.bat                      package all four templates (default)
rem   script\package_overleaf.bat backend              package only main_backend.tex
rem   script\package_overleaf.bat algorithm -Sanitize  package a desensitized copy (no real personal data)
