# qwen_guid 简历素材与面试知识清单

> 来源文件：`qwen_guid.md`、`main_algorithm_0616.tex`
>
...
| --- | --- | --- | --- |
| 三层记忆管理：短期窗口、长期摘要、结构化状态 | 重庆啄木鸟 - 小啄 GPT | 已写入 `main_algorithm_0616.tex` | 针对多轮客服对话中上下文丢失和槽位遗漏问题，设计“短期记忆 + 长期摘要 + 结构化状态”的记忆管理机制，在每轮 Prompt 中动态注入关键业务状态。 |
